...
#End Region
        ...
        Private Shared Sub AddColorScale2ConditionalFormatting(ByVal workbook As IWorkbook)
            ...
            Try
                ...
                Dim minPoint As ConditionalFormattingExtremumValue = worksheet.ConditionalFormattings.CreateExtremumValue()
                ' Set the maximum threshold to the highest value in the range of cells, which is evaluated automatically.
                Dim maxPoint As ConditionalFormattingExtremumValue = worksheet.ConditionalFormattings.CreateExtremumValue()
                ...
                Dim cfRule As ColorScale2ConditionalFormatting = worksheet.ConditionalFormattings.AddColorScale2ConditionalFormatting(worksheet.Range("$C$2:$D$15"), minPoint, Color.FromArgb(255, &H9D, &HE9, &HFA), maxPoint, Color.FromArgb(255, &HFF, &HF6, &HA9))
        ...
        Private Shared Sub AddColorScale3ConditionalFormatting(ByVal workbook As IWorkbook)
            ...
            Try
                ...
                Dim minPoint As ConditionalFormattingExtremumValue = worksheet.ConditionalFormattings.CreateExtremumValue(ConditionalFormattingValueType.Formula, "=MIN($C$2:$D$15)")
                ' Set the midpoint threshold to the 50th percentile.
                Dim midPoint As ConditionalFormattingInsideValue = worksheet.ConditionalFormattings.CreateInsideValue(ConditionalFormattingValueType.Percentile, "50")
                ' Set the maximum threshold to the highest value in the range of cells using the MAX() formula.
                Dim maxPoint As ConditionalFormattingExtremumValue = worksheet.ConditionalFormattings.CreateExtremumValue(ConditionalFormattingValueType.Number, "=MAX($C$2:$D$15)")
                ...
                Dim cfRule As ColorScale3ConditionalFormatting = worksheet.ConditionalFormattings.AddColorScale3ConditionalFormatting(worksheet.Range("$C$2:$D$15"), minPoint, Color.Red, midPoint, Color.Yellow, maxPoint, Color.SkyBlue)
        ...
        Private Shared Sub AddDataBarConditionalFormatting(ByVal workbook As IWorkbook)
            ...
            Try
                ...
                Dim lowBound1 As ConditionalFormattingExtremumValue = worksheet.ConditionalFormattings.CreateExtremumValue()
                ' Set the value corresponding to the longest bar to the highest value, which is evaluated automatically.
                Dim highBound1 As ConditionalFormattingExtremumValue = worksheet.ConditionalFormattings.CreateExtremumValue()
                ' Create the rule to compare values in cells E2 through E15 using data bars. 
                Dim cfRule1 As DataBarConditionalFormatting = worksheet.ConditionalFormattings.AddDataBarConditionalFormatting(worksheet.Range("$E$2:$E$15"), lowBound1, highBound1, DXColor.Green)
                ...
                Dim lowBound2 As ConditionalFormattingExtremumValue = worksheet.ConditionalFormattings.CreateExtremumValue(ConditionalFormattingValueType.Percent, "0")
                ' Set the value corresponding to the longest bar to 100 percent.
                Dim highBound2 As ConditionalFormattingExtremumValue = worksheet.ConditionalFormattings.CreateExtremumValue(ConditionalFormattingValueType.Percent, "100")
                ' Create the rule to compare values in cells G2 through G15 using data bars.  
                Dim cfRule2 As DataBarConditionalFormatting = worksheet.ConditionalFormattings.AddDataBarConditionalFormatting(worksheet.Range("$G$2:$G$15"), lowBound2, highBound2, DXColor.SkyBlue)
        ...
        Private Shared Sub AddIconSetConditionalFormatting(ByVal workbook As IWorkbook)
            ...
            Try
                ...
                Dim minPoint As ConditionalFormattingIconSetInsideValue = worksheet.ConditionalFormattings.CreateIconSetInsideValue(ConditionalFormattingValueType.Formula, "=MIN($E$2:$E$15)", ConditionalFormattingValueOperator.GreaterOrEqual)
                ' Set the second threshold to 0.
                Dim midPoint As ConditionalFormattingIconSetInsideValue = worksheet.ConditionalFormattings.CreateIconSetInsideValue(ConditionalFormattingValueType.Number, "0", ConditionalFormattingValueOperator.GreaterOrEqual)
                ' Set the third threshold to 0.01.
                Dim maxPoint As ConditionalFormattingIconSetInsideValue = worksheet.ConditionalFormattings.CreateIconSetInsideValue(ConditionalFormattingValueType.Number, "0.01", ConditionalFormattingValueOperator.GreaterOrEqual)
                ...
                Dim cfRule As IconSetConditionalFormatting = worksheet.ConditionalFormattings.AddIconSetConditionalFormatting(worksheet.Range("$E$2:$E$15"), IconSetType.Arrows3, New ConditionalFormattingIconSetInsideValue() {minPoint, midPoint, maxPoint})
